...
$keranjang = mysqli_query($mysqli, "SELECT * FROM keranjang") or die("data salah: " . mysqli_error($mysqli));
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                          <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php while ($show = mysqli_fetch_array($keranjang)) { ?>
                                        <tr>
                                            <td><?php echo $show['id_penyewa']; ?></td>
                                            <td><?php echo $show['id_paket']; ?></td>
                                            <td><?php echo $show['total']; ?></td>
                                            <td><?php echo $show['tanggal']; ?></td>
                                            <td><?php echo $show['jam_pemesanan']; ?></td>
                                            <td><?php echo $show['status']; ?></td>
                                            <td>
                                                <a href="edit-keranjang.php?id_keranjang=<?php echo $show['id_keranjang']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-info pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"> Edit</i></a>
                                                <a href="delete-keranjang.php?id_keranjang=<?php echo $show['id_keranjang']; ?>" data-toggle="tooltip" title="Delete" class="btn btn-danger pd-setting-ed" onClick='return confirm("Apakah anda yakin menghapus data ini?")'><i class="fa fa-trash-square-o" aria-hidden="true">Delete</i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
