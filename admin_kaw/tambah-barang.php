                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                       <!--  <li>
                        ...
                        <li>
                        <a title="Data Keranjang" href="keranjang.php"><i class="icon nalika-folder icon-wrap"></i><span class="mini-click-non">Data Keranjang</span></a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Data Pelanggan" href="list-akun.php"><span class="mini-sub-pro">Data Pelanggan</span></a></li>                                
                            </ul>
                        </li>
                    </ul>
                </nav>
