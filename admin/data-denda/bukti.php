    ...
    <div class="all-content-wrapper">
        ...
        <div class="product-status mg-b-30">
            <div class="container-fluid">
                ...
                <br>
                    <a href="data-denda.php" class="btn btn-primary"> Kembali &times; </a>
                    <br><br><br>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td> <img id="myImg" src="../../img/Uploads/denda/<?php echo $show["BUKTI_DENDA"]; ?>" alt="Bukti Denda" style="width:100%;max-width:300px"></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
