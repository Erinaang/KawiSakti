...
//SELECT DATA
$idStok = $_GET['ID_STOK'];
$query = mysqli_query($mysqli, "SELECT * FROM stok WHERE ID_STOK = '$idStok'") or die("data salah: " . mysqli_error($mysqli));

if (isset($_POST['submit'])) {
    $stok = $_POST['stok'];

    $query = mysqli_query($mysqli, "UPDATE stok SET STOK='$stok' WHERE ID_STOK='$idStok'") or die("data salah: " . mysqli_error($mysqli));
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="review-content-section">
                                                            ...
                                                            <div class="input-group mg-b-pro-edt">
                                                                <span class="input-group-addon"><i class="fa fa-edit" aria-hidden="true"> Stok :</i></span>
                                                                <input name="stok" type="number" class="form-control" value="<?php echo $show['STOK']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
