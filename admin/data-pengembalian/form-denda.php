...
$queryKeranjang = mysqli_query($mysqli, "SELECT * FROM keranjang as kr JOIN paket as pk ON kr.id_paket = pk.id_paket WHERE kr.id_penyewa='$idPenyewa' AND kr.jam_pemesanan='$jam_pesan'") or die("data salah: " . mysqli_error($mysqli));
